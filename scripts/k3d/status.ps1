...
Show-Section "🔧 Core Services:" "kubectl get svc -A | Select-String -Pattern '(argocd|otel|traefik|keda)'"
Show-Section "📦 ArgoCD Applications:" "kubectl get applications -n argocd"
Show-Section "📦 OTEL DaemonSet (observability):" "kubectl get daemonsets -n observability"
Show-Section "📦 Pods (observability):" "kubectl get pods -n observability"
