...
- [🎯 Three Development Modes](#-three-development-modes)
  - [🐳 Docker Compose Mode](#-docker-compose-mode-recommended-for-daily-development)
  - [🎨 Visual Studio AppHost Mode](#-visual-studio-apphost-mode-integrated-debugging)
  - [☸️ K3D Mode](#️-k3d-mode-professional-testing--gitops)
